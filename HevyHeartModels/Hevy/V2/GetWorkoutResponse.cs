...
public class GetExercise
{
    ...
    /// <summary>
    /// Gets or sets the Spanish (Espa�ol) localized title for the exercise.
    /// Null if translation is not available.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the French (Fran�ais) localized title for the exercise.
    /// Null if translation is not available.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the Portuguese (Portugu�s) localized title for the exercise.
    /// Null if translation is not available.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the Turkish (T�rk�e) localized title for the exercise.
    /// Null if translation is not available.
    /// </summary>
